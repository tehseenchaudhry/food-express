...
import {  FaUser,  FaEnvelope,  FaLock,  FaPhone,
  FaArrowLeft
} from "react-icons/fa";
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10 relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            <p className="text-gray-500">Join us and get delicious food delivered</p>
          </div>
          ...
          <p className="mt-3 text-center text-gray-600">
            ...
            <Link to="/login" className="text-rose-800 font-semibold hover:underline">
              Sign in
            </Link>
          </p>
        </div>
